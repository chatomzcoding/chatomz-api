    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-3">
                    <a href="{{ url('informasidoa') }}" class="d-flex align-items-center">
                      <div class="avatar avatar-sm me-2">
                        <img src="{{ asset('img/informasi/doa.jpg') }}" alt="Avatar" class="rounded-circle"/>
                      </div>
                      <div class="me-2 text-body h5 mb-0">Doa - Doa</div>
                    </a>
                    <div class="ms-auto">
                      <ul class="list-inline mb-0 d-flex align-items-center">
                        <li class="list-inline-item me-0">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-3">
                    <a href="{{ url('informasigunung') }}" class="d-flex align-items-center">
                      <div class="avatar avatar-sm me-2">
                        <img src="{{ asset('img/informasi/gunung.jpg') }}" alt="Avatar" class="rounded-circle"/>
                      </div>
                      <div class="me-2 text-body h5 mb-0">Gunung</div>
                    </a>
                    <div class="ms-auto">
                      <ul class="list-inline mb-0 d-flex align-items-center">
                        <li class="list-inline-item me-0">
